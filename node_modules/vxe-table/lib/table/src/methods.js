...
var Methods = {
      ...
      return new Promise(function (resolve) {
        _this3.$nextTick().then(function () {
          ...
          if (oldScrollYLoad === sYLoad) {
            (0, _util.restoreScrollLocation)(_this3, lastScrollLeft, lastScrollTop).then(resolve);
          } else {
            setTimeout(function () {
              return (0, _util.restoreScrollLocation)(_this3, lastScrollLeft, lastScrollTop).then(resolve);
            });
          }
        });
      });
  ...
  handleColumn: function handleColumn(collectColumn) {
    ...
    this.parseColumns().then(function () {
      if (_this8.scrollXLoad) {
        _this8.loadScrollXData(true);
      }
    });
    this.clearMergeCells();
    this.clearMergeFooterItems();
  ...
  loadTreeChildren: function loadTreeChildren(row, childRecords) {
    ...
    return this.createData(childRecords).then(function (rows) {
      ...
      _xeUtils.default.eachTree(rows, function (childRow, index, items, path, parent, nodes) {
        var rowid = getRowid(_this10, childRow);
        var rest = {
          row: childRow,
          rowid: rowid,
          seq: -1,
  ...
  cacheColumnMap: function cacheColumnMap() {
    ...
    var handleFunc = function handleFunc(column, index, items, path, parent) {
      ...
      if (process.env.NODE_ENV === 'development') {
        if (_this11.showOverflow && column.showOverflow === false) {
          _tools.UtilTools.warn('vxe.error.errConflicts', ["table.show-overflow=".concat(_this11.showOverflow), "column.show-overflow=".concat(column.showOverflow)]);
        }

        if (_this11.showHeaderOverflow && column.showHeaderOverflow === false) {
          _tools.UtilTools.warn('vxe.error.errConflicts', ["table.show-header-overflow=".concat(_this11.showHeaderOverflow), "column.show-header-overflow=".concat(column.showHeaderOverflow)]);
        }

        if (_this11.showFooterOverflow && column.showFooterOverflow === false) {
          _tools.UtilTools.warn('vxe.error.errConflicts', ["table.show-footer-overflow=".concat(_this11.showFooterOverflow), "column.show-footer-overflow=".concat(column.showFooterOverflow)]);
        }
      }
  ...
  createRow: function createRow(records) {
    ...
    return this.$nextTick().then(function () {
      return _this13.createData(records).then(function (rows) {
  ...
  revertData: function revertData(rows, field) {
    ...
    if (targetRows.length) {
      targetRows.forEach(function (row) {
        if (!_this14.isInsertByRow(row)) {
          var rowIndex = _this14.getRowIndex(row);
  ...
  isUpdateByRow: function isUpdateByRow(row, field) {
    ...
    if (keepSource) {
      ...
      if (treeConfig) {
        ...
        var matchObj = _xeUtils.default.findTree(tableSourceData, function (item) {
          return rowid === getRowid(_this15, item);
        }, treeOpts);
        ...
        if (allSortMethod) {
          ...
          tableTree = _xeUtils.default.orderBy(tableTree, orderColumns.map(function (_ref2) {
            var column = _ref2.column,
                order = _ref2.order;
            return [getOrderField(_this16, column), order];
          }));
        }
  ...
  updateAfterDataIndex: function updateAfterDataIndex() {
    ...
    if (treeConfig) {
      _xeUtils.default.eachTree(afterTreeFullData, function (row, index, items, path) {
        var rowid = getRowid(_this17, row);
  ...
  handleLoadDefaults: function handleLoadDefaults() {
    ...
    this.$nextTick(function () {
      return setTimeout(_this18.recalculate);
    });
  },
  ...
  refreshColumn: function refreshColumn() {
    ...
    return this.parseColumns().then(function () {
      return _this19.refreshScroll();
    }).then(function () {
      return _this19.recalculate();
    });
  },
    ...
    if (bodyElem) {
      ...
      if (refull === true) {
        ...
        return this.computeScrollLoad().then(function () {
          _this21.autoCellWidth(headerElem, bodyElem, footerElem);

          return _this21.computeScrollLoad();
        });
      }
    }
        ...
        if (layout === 'header') {
          ...
          if (isGroup && listElem) {
            _xeUtils.default.arrayEach(listElem.querySelectorAll('.col--group'), function (thElem) {
              var colNode = _this22.getColumnNode(thElem);
            ...
            if (fullColumnIdData[colid]) {
              ...
              if (_listElem) {
                _xeUtils.default.arrayEach(_listElem.querySelectorAll(".".concat(column.id)), function (elem) {
                  ...
                  if (cellElem) {
                    if (colspan > 1) {
                      var columnIndex = _this22.getColumnIndex(column);

                      for (var _index = 1; _index < colspan; _index++) {
                        var nextColumn = _this22.getColumns(columnIndex + _index);
          ...
          if (validTip && getEventTargetNode(evnt, validTip.$el).flag) {// 如果是激活状态，且点击了校验提示框
            ...
            if (!getEventTargetNode(evnt, document.body, 'vxe-table--ignore-clear').flag) {
              ...
              this.preventEvent(evnt, 'event.clearActived', actived.args, function () {
                ...
                if (!isClearActived && _this24.height && !_this24.overflowY) {
      ...
      if (!getEventTargetNode(evnt, $el).flag && !($xegrid && getEventTargetNode(evnt, $xegrid.$el).flag) && !(ctxWrapper && getEventTargetNode(evnt, ctxWrapper.$el).flag) && !($toolbar && getEventTargetNode(evnt, $toolbar.$el).flag)) {
        ...
        if (!getEventTargetNode(evnt, document.body, 'vxe-table--ignore-areas-clear').flag) {
          this.preventEvent(evnt, 'event.clearAreas', {}, function () {
            _this24.clearCellAreas();

            _this24.clearCopyCellArea();
          });
        }
      }
  ...
  keydownEvent: function keydownEvent(evnt) {
    ...
    if (isEsc) {
      this.preventEvent(evnt, 'event.keydown', null, function () {
        if (keyboardConfig && mouseConfig && mouseOpts.area && _this25.handleKeyboardEvent) {
          _this25.handleKeyboardEvent(evnt);
            ...
            if (actived.row) {
              ...
              if (mouseConfig && mouseOpts.selected) {
                _this25.$nextTick(function () {
                  return _this25.handleSelected(params, evnt);
                });
              }
            }
          }
        ...
        _this25.emitEvent('keydown', {}, evnt);
      });
    }
  },
  ...
  handleGlobalKeydownEvent: function handleGlobalKeydownEvent(evnt) {
    ...
    if (this.isActivated) {
      this.preventEvent(evnt, 'event.keydown', null, function () {
        var filterStore = _this26.filterStore,
            isCtxMenu = _this26.isCtxMenu,
            ctxMenuStore = _this26.ctxMenuStore,
            editStore = _this26.editStore,
            editOpts = _this26.editOpts,
            editConfig = _this26.editConfig,
            mouseConfig = _this26.mouseConfig,
            mouseOpts = _this26.mouseOpts,
            keyboardConfig = _this26.keyboardConfig,
            keyboardOpts = _this26.keyboardOpts,
            ...
            bodyCtxMenu = _this26.bodyCtxMenu,
            rowOpts = _this26.rowOpts;
        ...
        if (operCtxMenu) {
        ...
        } else if (keyboardConfig && mouseConfig && mouseOpts.area && _this26.handleKeyboardEvent) {
          _this26.handleKeyboardEvent(evnt);
          ...
          if (selected.column.type === 'checkbox') {
            _this26.handleToggleCheckRowEvent(evnt, selected.args);
          } else {
          ...
          // 如果按下上下文键
          _this26._keyCtx = selected.row && selected.column && bodyCtxMenu.length;
          clearTimeout(_this26.keyCtxTimeout);
          _this26.keyCtxTimeout = setTimeout(function () {
            _this26._keyCtx = false;
          }, 1000);
            ...
            if (actived.row) {
              ...
              if (mouseConfig && mouseOpts.selected) {
                _this26.$nextTick(function () {
                  return _this26.handleSelected(params, evnt);
                });
              }
            }
          } else {
            ...
            if (selected.row || actived.row) {
              ...
              if (hasShiftKey) {
                if (keyboardOpts.enterToTab) {
                  _this26.moveTabSelected(targetArgs, hasShiftKey, evnt);
                } else {
                  _this26.moveSelected(targetArgs, isLeftArrow, true, isRightArrow, false, evnt);
                }
              } else {
                if (keyboardOpts.enterToTab) {
                  _this26.moveTabSelected(targetArgs, hasShiftKey, evnt);
                } else {
                  _this26.moveSelected(targetArgs, isLeftArrow, false, isRightArrow, true, evnt);
                }
              }
              ...
              if (childrens && childrens.length) {
                ...
                _this26.setTreeExpand(currentRow, true).then(function () {
          ...
          // 如果按下了 Tab 键切换
          if (selected.row || selected.column) {
            _this26.moveTabSelected(selected.args, hasShiftKey, evnt);
          } else if (actived.row || actived.column) {
            _this26.moveTabSelected(actived.args, hasShiftKey, evnt);
          }
          ...
          if (!isEditStatus) {
            ...
            if (keyboardOpts.isDel && (selected.row || selected.column)) {
              if (delMethod) {
                delMethod({
                  row: selected.row,
                  rowIndex: _this26.getRowIndex(selected.row),
                  column: selected.column,
                  columnIndex: _this26.getColumnIndex(selected.column),
                  $table: _this26
                });
              } else {
              ...
              if (parentRow) {
                ...
                _this26.setTreeExpand(parentRow, false).then(function () {
        ...
        _this26.emitEvent('keydown', {}, evnt);
      });
    }
  },
  ...
  handleTargetLeaveEvent: function handleTargetLeaveEvent() {
    ...
    if (tooltipOpts.enterable) {
      this.tooltipTimeout = setTimeout(function () {
        var tooltip = _this28.$refs.tooltip;

        if (tooltip && !tooltip.isHover) {
          _this28.closeTooltip();
        }
      }, tooltipOpts.leaveDelay);
    } else {
      this.closeTooltip();
  ...
  setCheckboxRow: function setCheckboxRow(rows, value) {
    ...
    rows.forEach(function (row) {
      return _this29.handleSelectRow({
        row: row
      }, !!value);
    });
    return this.$nextTick();
        ...
        if (value === -1) {
          ...
          _xeUtils.default.eachTree([row], function (item) {
            if (row === item || !checkMethod || checkMethod({
              ...
              _this30.handleCheckboxReserveRow(row, value);
            }
          }, treeOpts);
        } // 如果存在父节点，更新父节点状态
      ...
      if (reserve) {
        if (value) {
          selectRows.forEach(function (row) {
            checkboxReserveRowMap[getRowid(_this31, row)] = row;
          });
        } else {
  ...
  getCheckboxReserveRecords: function getCheckboxReserveRecords(isFull) {
    ...
    if (checkboxOpts.reserve) {
      ...
      if (treeConfig) {
        _xeUtils.default.eachTree(afterFullData, function (row) {
          afterFullIdMaps[getRowid(_this32, row)] = 1;
        }, treeOpts);
      } else {
        afterFullData.forEach(function (row) {
          afterFullIdMaps[getRowid(_this32, row)] = 1;
    ...
    if (defaultSort) {
      ...
      if (defaultSort.length) {
        (sortConfig.multiple ? defaultSort : defaultSort.slice(0, 1)).forEach(function (item) {
          ...
          if (field && order) {
            var column = _this36.getColumnByField(field);
    ...
    if (sortConfs.length) {
      ...
      (multiple ? sortConfs : [sortConfs[0]]).forEach(function (confs) {
        ...
        if (_xeUtils.default.isString(field)) {
          column = _this37.getColumnByField(field);
        }
        ...
        if (column && (column.sortable || column.remoteSort)) {
          ...
          if (orders.indexOf(order) === -1) {
            order = getNextSortOrder(_this37, column);
          }
  ...
  reloadRowExpand: function reloadRowExpand(row) {
    ...
    if (lazy && expandLazyLoadeds.indexOf(row) === -1) {
      this.clearRowExpandLoaded(row).then(function () {
        return _this38.handleAsyncRowExpand(row);
      });
    }
  ...
  handleAsyncRowExpand: function handleAsyncRowExpand(row) {
    ...
    var rest = this.fullAllDataRowMap.get(row);
    return new Promise(function (resolve) {
      _this39.expandLazyLoadeds.push(row);

      _this39.expandOpts.loadMethod({
        $table: _this39,
        row: row,
        ...
        _xeUtils.default.remove(_this39.expandLazyLoadeds, function (item) {
          return item === row;
        });

        _this39.rowExpandeds.push(row);

        resolve(_this39.$nextTick().then(_this39.recalculate));
      });
    });
  },
  ...
  setRowExpand: function setRowExpand(rows, expanded) {
    ...
    if (rows) {
      ...
      if (expanded) {
        validRows.forEach(function (row) {
          if (rowExpandeds.indexOf(row) === -1) {
            ...
            if (isLoad) {
              lazyRests.push(_this40.handleAsyncRowExpand(row));
            } else {
      ...
      if (reserve) {
        validRows.forEach(function (row) {
          return _this40.handleRowExpandReserve(row, expanded);
        });
      }
    }
  ...
  clearRowExpand: function clearRowExpand() {
    ...
    if (reserve) {
      tableFullData.forEach(function (row) {
        return _this41.handleRowExpandReserve(row, false);
      });
    }
  ...
  reloadTreeExpand: function reloadTreeExpand(row) {
    ...
    if (lazy && row[hasChild] && treeLazyLoadeds.indexOf(row) === -1) {
      this.clearTreeExpandLoaded(row).then(function () {
        return _this42.handleAsyncTreeExpandChilds(row);
      }).then(function () {
        if (transform) {
          _this42.handleVirtualTreeToList();

          return _this42.handleTableData();
        }
      }).then(function () {
        return _this42.recalculate();
      });
    }
  ...
  handleAsyncTreeExpandChilds: function handleAsyncTreeExpandChilds(row) {
    ...
    return new Promise(function (resolve) {
      ...
      loadMethod({
        ...
        if (childRecords) {
          _this43.loadTreeChildren(row, childRecords).then(function (childRows) {
            if (childRows.length && treeExpandeds.indexOf(row) === -1) {
              treeExpandeds.push(row);
            } // 如果当前节点已选中，则展开后子节点也被选中


            if (!checkStrictly && _this43.isCheckedByCheckboxRow(row)) {
              _this43.setCheckboxRow(childRows, true);
            }

            _this43.$nextTick().then(function () {
              if (transform) {
  ...
  handleBaseTreeExpand: function handleBaseTreeExpand(rows, expanded) {
    ...
    if (reserve) {
      validRows.forEach(function (row) {
        return _this44.handleTreeExpandReserve(row, expanded);
      });
    }
  ...
  handleVirtualTreeExpand: function handleVirtualTreeExpand(rows, expanded) {
    ...
    return this.handleBaseTreeExpand(rows, expanded).then(function () {
      _this45.handleVirtualTreeToList();
  ...
  clearTreeExpand: function clearTreeExpand() {
    ...
    if (reserve) {
      _xeUtils.default.eachTree(tableFullData, function (row) {
        return _this46.handleTreeExpandReserve(row, false);
      }, treeOpts);
    }
  ...
  computeScrollLoad: function computeScrollLoad() {
    ...
    return this.$nextTick().then(function () {
      var sYOpts = _this47.sYOpts,
          sXOpts = _this47.sXOpts,
          scrollXLoad = _this47.scrollXLoad,
          scrollYLoad = _this47.scrollYLoad,
          scrollXStore = _this47.scrollXStore,
          scrollYStore = _this47.scrollYStore; // 计算 X 逻辑

      if (scrollXLoad) {
        var _computeVirtualX3 = computeVirtualX(_this47),
        ...
        _this47.updateScrollXData();
      } else {
        _this47.updateScrollXSpace();
      } // 计算 Y 逻辑


      var _computeVirtualY = computeVirtualY(_this47),
      ...
      if (scrollYLoad) {
        ...
        _this47.updateScrollYData();
      } else {
        _this47.updateScrollYSpace();
      }

      _this47.rowHeight = rowHeight;

      _this47.$nextTick(_this47.updateStyle);
    });
  },
  ...
  scrollToTreeRow: function scrollToTreeRow(row) {
    ...
    if (treeConfig) {
      ...
      if (matchObj) {
        ...
        nodes.forEach(function (row, index) {
          if (index < nodes.length - 1 && !_this49.isTreeExpandByRow(row)) {
            rests.push(_this49.setTreeExpand(row, true));
          }
        });
      }
    }
    ...
    return Promise.all(rests).then(function () {
      return _tools.DomTools.rowToVisible(_this49, row);
    });
  },
    ...
    return this.$nextTick().then(function () {
      ...
      if (scope && $refs.tableBody && editRules) {
        ...
        if (_this50.hasCellRules(type, row, column)) {
          var cell = _this50.getCell(row, column);
